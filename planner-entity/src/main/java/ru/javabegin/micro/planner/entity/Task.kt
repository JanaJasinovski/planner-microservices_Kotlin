...
class Task : Serializable {
    ...
    var taskDate: // в БД поле называется task_date, т.к. нельзя использовать системное имя date
            Date? = null
    ...
    var priority: // по каким полям связывать (foreign key)
            Priority? = null
    ...
    var category: // по каким полям связывать (foreign key)
            Category? = null
